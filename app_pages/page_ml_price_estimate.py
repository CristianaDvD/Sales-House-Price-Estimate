...
from src.machine_learning.evaluate_reg import regression_evaluation_plots, regression_performance
...
def page_ml_predict_price_body():
    ...
    st.info(
        ...
        versions of the model to make sure that we don't overlook potential improvement.\n"
        f"* The pipeline performance for the best model on the train and test set is\
        R2 == 0.84 and R2 == 0.77 respectively.\n"
        f"* We present the pipeline steps, best features list along with feature importance plot,\
    ...
    st.write(
        f"The feature importance plot reveals and confirms our initial hypotheses:\n"
        ...
        f"* Houses with extra spaces get to a higher sale price, and here we can include **TotalBsmtSF and GarageArea**.")
