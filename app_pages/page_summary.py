...
def page_summary_body():
    ...
    st.info(
        ...
        f"* **Inherited house** is a house that the client inherited from great-grandfather.\n"
    )

    # text based on README file - "Dataset Content" section
    st.info(
        f"📌 **Project Dataset**\n"
        f"* The dataset, which consists of 1460 rows, represents housing records from Ames, Iowa.\
            For homes constructed between 1872 and 2010, it shows the house profile \
            (Floor Area, Basement, Garage, Kitchen, Lot, Porch, Wood Deck, Year Built)\
            and its corresponding sale price.\n"
        f"* It is available in [Kaggle via Code Institute](https://www.kaggle.com/codeinstitute/housing-prices-data)\n"
        f"* The dataset of inherited homes with the identical characteristics as the primary data set,\
        aside from the SalePrice, which we must assist in forecasting, is also provided."
    )
