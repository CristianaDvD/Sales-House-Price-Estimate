...
from src.data_management import load_houses_data, load_inherited_data, load_pkl_file
from src.machine_learning.predictive_analysis_func import predict_price, predict_inherited_house_price 
...
def page_predict_price_body():
	...
	st.info(
		f"The main reason for building this app was to answer our business requirement no.2:"
	...
	st.write("Enter the following properties' accurate values, then click on the 'Estimate Sale Price' button.")
